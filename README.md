...
2. Open the `main.py` file and click **Run**.
...
1. **Launch the App:** Once executed, the tool will automatically open a GUI panel in your default web browser.
2. **Select Folder:** Choose the target directory that you want to optimize.
3. **Choose Filter:** Enter the number corresponding to your preferred sorting rule:
